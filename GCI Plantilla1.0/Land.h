...
public:
	...
	Land(HWND hWnd, OpenGLClass* OpenGL, TextureClass* LoaderTextureReference, const wchar_t* mapaDeAlturaHeightmap, string indiceTextura1, string indiceTextura2,
		float anchoDeseado, float profundidadDeseada, int numtext, int numtext2)
	{
		...
		m_textureID = LoaderTextureReference->Initialize(indiceTextura2, true);
	}
