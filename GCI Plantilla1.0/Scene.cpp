...
bool Scene::Render() {
	...
	// Para renderizar una escena es necesario contar con un shader almenos para enviar
	// informacion de vertices y UV, asi mismo pasarle las matrices generales
	LightShader->SetShader();
	LightShader->PonMatriz4x4((char*)"worldMatrix", worldMatrix);
	LightShader->PonMatriz4x4((char*)"viewMatrix", viewMatrix);
	LightShader->PonMatriz4x4((char*)"projectionMatrix", projectionMatrix);
